...
3. Label overlap — connector labels must not overlap arrows, boxes, or other text
4. Callout overflow — wrap long descriptions into separate text lines inside the callout box
5. viewBox too small — content clipped
6. Floating labels — every text should be in a box, legend, or connected by leader
7. Connector without fill="none" — renders as black shape
8. Missing dominant-baseline="central" — text sits 4px too high
9. Missing arrow marker in defs — always include it

## Pre-render geometry checklist
